  ...
  try {
    enviado = await enviarPeloGmail(
      caixa.usuarioId,
      {
        ...
        para: destino,
        assunto,
        // O `comoCarta` saiu junto com a tarja e o card: o e-mail ja e texto
        // mais assinatura, que e o que uma resposta de gente parece. A logo
        // acompanha, como no resto do sistema.
