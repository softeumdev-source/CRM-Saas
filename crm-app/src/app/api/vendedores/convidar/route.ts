...
export async function POST(request: Request) {
  ...
  // O papel vinha cravado como "vendedor" embora a RPC já o aceitasse como
  // parâmetro. Validado aqui contra a lista, que é a mesma do CHECK do banco:
  // sem isso, um papel inválido só falharia lá embaixo, com erro de constraint.
