...
export default async function AdminPage() {
  ...
  const [{ data: usuarios }, { data: convites }, { data: planos }, { data: negocios }, { data: etapas }, { data: contatosSemDono }, { data: contatosComDono }, { data: historicoEtapas }] = await Promise.all([
