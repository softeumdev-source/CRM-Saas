...
export const estilos = StyleSheet.create({
  ...
  capaMarca: { fontSize: 22, fontWeight: 700, letterSpacing: 1 },
  capaTag: { fontSize: 9, color: "#a5b4fc", marginTop: 4 },
  capaTitulo: { fontSize: 26, fontWeight: 700, marginTop: 140, lineHeight: 1.25 },
  capaCliente: { fontSize: 14, color: "#cbd5e1", marginTop: 10 },
  capaMeta: { fontSize: 9, color: "#94a3b8", marginTop: 4 },
  capaRodape: { fontSize: 8, color: "#64748b" },
